<template>
  <view class="template-product tn-safe-area-inset-bottom">
    ...
    <view class="tn-margin">
      <view class="tn-flex tn-flex-row-between">
        ...
        <view class="justify-content-item">
          <view class="icon15__item--icon tn-flex tn-flex-row-center tn-flex-col-center tn-shadow-blur button-1" @click="tn('/pageA/pano/pano')">
    ...
    <tn-scroll-list :indicator="false">
      <view class="tn-flex tn-margin">
        <view class="tn-margin-right-sm" v-for="(item, index) in 10" :key="index">
          <view class="image-pic" @tap="previewProductImage" style="background-image:url('https://resource.tuniaokj.com/images/uniapp_market/1.jpg');">
    ...
    <view class="content-backgroup tn-margin">
      <image src='https://cdn.nlark.com/yuque/0/2023/jpeg/280373/1680077186004-assets/web-upload/c3551495-0ef4-4666-9fc5-cd4c5bc251de.jpeg' mode='widthFix' class='backgroud-image'></image>
      <image src='https://cdn.nlark.com/yuque/0/2023/jpeg/280373/1680077186004-assets/web-upload/c3551495-0ef4-4666-9fc5-cd4c5bc251de.jpeg' mode='widthFix' class='backgroud-image'></image>
      <image src='https://cdn.nlark.com/yuque/0/2023/jpeg/280373/1680077186004-assets/web-upload/c3551495-0ef4-4666-9fc5-cd4c5bc251de.jpeg' mode='widthFix' class='backgroud-image'></image>
    </view>
    ...
    <view id="top-info" class="tn-footerfixed tn-safe-area-inset-bottom tn-bg-white" :style="{transform: `translateY(${topInfoTranslateY}px)`}">
      <!-- <view class="footerfixed tn-bg-white tn-safe-area-inset-bottom"> -->
        <view class="tn-flex tn-flex-row-between tn-flex-col-center">
          ...
          <view class="tn-flex-3 justify-content-item tn-padding-top-sm tn-padding-bottom-sm" @tap.stop="openSkuModal">
            <tn-button shape="round" backgroundColor="tn-main-gradient-red" padding="38rpx 0" width="92%" :fontSize="30" shadow>
