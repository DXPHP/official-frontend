  ...
  <view class="template-content tn-safe-area-inset-bottom">
    ...
    <view class="tn-padding-bottom" style="margin-top: -50rpx;">
      ...
      <view class="nav-shadow tn-margin tn-padding" @click="copyVideo">
        ...
        <view class="tn-text-justify clamp-text-2 tn-padding-top-sm tn-color-gray--dark">
          智途UI快速搭建uniapp项目、组件按需引入视频教程，视频长度4分钟。
        </view>
      </view>
      ...
      <view class="nav-shadow tn-margin tn-padding" @click="copySource">
        <view class="tn-flex tn-flex-direction-row tn-flex-col-center tn-flex-row-between">
          <view class="tn-flex">
            ...
            <view class="tn-flex tn-margin-left-xs" style="width: 400rpx;">
              <text class="clamp-text-1 tn-text-bold">智途素材社区</text>
            </view>
          </view>
          <view class="tn-color-gray">
            复制链接
        ...
        <view class="tn-text-justify clamp-text-2 tn-padding-top-sm tn-color-gray--dark">
          智途免费商用素材，链接地址直接下载原图，或群公告获取素材包进行下载。
        </view>
      </view>
      ...
      <view class="nav-shadow tn-margin tn-padding" @click="copyUi">
        <view class="tn-flex tn-flex-direction-row tn-flex-col-center tn-flex-row-between">
          <view class="tn-flex">
            ...
            <view class="tn-flex tn-margin-left-xs" style="width: 400rpx;">
              <text class="clamp-text-1 tn-text-bold">智途UI</text>
            </view>
          </view>
          <view class="tn-color-gray">
            复制链接
        ...
        <view class="tn-text-justify clamp-text-2 tn-padding-top-sm tn-color-gray--dark">
          智途UI发布于DCloud插件市场上的免费可商用开源地址，支持适配微信小程序、APP、H5。
        </view>
      </view>
      ...
      <view class="nav-shadow tn-margin tn-padding">
        <view class="tn-flex tn-flex-direction-row tn-flex-col-center tn-flex-row-between">
          <view class="tn-flex">
            ...
            <view class="tn-flex tn-margin-left-xs" style="width: 400rpx;">
              <text class="clamp-text-1 tn-text-bold">智途国际学院教务处电话</text>
            </view>
          </view>
          <view class="tn-color-gray">
            拨打电话
      ...
      <view class="nav-shadow tn-margin tn-padding">
        <view class="tn-flex tn-flex-direction-row tn-flex-col-center tn-flex-row-between">
          <view class="tn-flex">
            ...
            <view class="tn-flex tn-margin-left-xs" style="width: 400rpx;">
              <text class="clamp-text-1 tn-text-bold">智途国际学院医务室电话</text>
            </view>
          </view>
          <view class="tn-color-gray">
            拨打电话
      ...
      <view class="nav-shadow tn-margin tn-padding">
        <view class="tn-flex tn-flex-direction-row tn-flex-col-center tn-flex-row-between">
          <view class="tn-flex">
            ...
            <view class="tn-flex tn-margin-left-xs" style="width: 400rpx;">
              <text class="clamp-text-1 tn-text-bold">智途国际学院邮编</text>
            </view>
          </view>
          <view class="tn-color-gray">
            复制邮编
      ...
      <view class="nav-shadow tn-margin tn-padding" v-for="(item, index) in 2" :key="index">
        <view class="tn-flex tn-flex-direction-row tn-flex-col-center tn-flex-row-between">
          <view class="tn-flex">
            ...
            <view class="tn-flex tn-margin-left-xs" style="width: 400rpx;">
              <text class="clamp-text-1 tn-text-bold">智途科技-公众号</text>
            </view>
          </view>
          <view class="tn-color-gray">
            跳转公众号
