  ...
  <view class="tn-safe-area-inset-bottom">
    ...
    <tn-modal v-model="show1" :custom="true">
      <view class="custom-modal-content">
        <image class="tn-radius" src='https://cdn.nlark.com/yuque/0/2023/jpeg/280373/1683185728989-assets/web-upload/af525e21-57d0-4403-9c13-bf073d632638.jpeg' mode='aspectFill' style="width: 100%;"></image>
      ...
      <view class="" style="padding: 30rpx 20rpx;" >
          <tn-waterfall ref="waterfall" v-model="list" @finish="handleWaterFallFinish">
            <template v-slot:left="{ leftList }">
              <view v-for="(item, index) in leftList" :key="item.id" class="product__item" @click="tn('/pageA/photo/photo')">
            ...
            <template v-slot:right="{ rightList }">
              <view v-for="(item, index) in rightList" :key="item.id" class="product__item" @click="tn('/pageA/photo/photo')">
                <view class="item__image">
                  <tn-lazy-load :threshold="6000" height="100%" :image="item.mainImage" :index="item.id" imgMode="widthFix"></tn-lazy-load>
                </view>
                <!-- <view class="item__data">
    ...
    data(){
      return {
        ...
        swiperList: [{
          ...
          id: 1,
          type: 'image',
          url: 'https://cdn.nlark.com/yuque/0/2022/jpeg/280373/1671437658295-assets/web-upload/05620a1f-452e-4a14-9d30-f6c66ee4be1c.jpeg',
        }, {
          id: 2,
          type: 'image',
          url: 'https://cdn.nlark.com/yuque/0/2023/jpeg/280373/1683551116254-assets/web-upload/96b7cdd7-cbf6-44fa-bf1a-326f35262f0c.jpeg',
        }, {
          id: 3,
          type: 'image',
          url: 'https://cdn.nlark.com/yuque/0/2023/jpeg/280373/1683551116261-assets/web-upload/4fd332a1-171f-4b54-9423-41b08513b8ab.jpeg',
        },
        {
          id: 4,
          type: 'image',
          url: 'https://cdn.nlark.com/yuque/0/2023/jpeg/280373/1683551116300-assets/web-upload/b46d51a8-aaa9-4600-9394-818216e7dc8c.jpeg',
        }],
