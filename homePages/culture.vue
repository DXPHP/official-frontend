  ...
  <view class="template-start">
    ...
    <swiper class="card-swiper" :circular="true"
      ...
      <swiper-item v-for="(item,index) in swiperList" :key="index" :class="cardCur==index?'cur':''">
        ...
        <view class="swiper-item image-banner" :style="'background-image:url('+ item.url + ');background-size: cover;border-radius: 15rpx;height: 100vh;width: 100vw;'">
        </view>
        <!-- <view class="swiper-item-png image-banner">
          <image :src="item.pngurl" mode="widthFix" v-if="item.type=='image'"></image>
        </view> -->
        <view class="swiper-item-png image-banner" :style="'background-image:url('+ item.pngurl + ');background-size: cover;border-radius: 15rpx;height: 924rpx;width: 750rpx;'">
        </view>
