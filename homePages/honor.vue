<template>
  <view class="">
    ...
    <view class="tn-margin-sm tn-text-center" :style="{paddingTop: vuex_custom_bar_height + 20 +'px'}">
      <!-- 比例图文 start-->
                ...
                <view class="">
                  <view class=" ">
                    ...
                    <view class="tn-text-center">
                      <text class="tn-color-black tn-text-sm tn-text-bold">{{ item.userName }}</text>
                    </view>
