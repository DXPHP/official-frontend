  ...
  <view class="template-group tn-safe-area-inset-bottom">
    ...
    <tn-nav-bar fixed customBack :bottomShadow="false" :backgroundColor="navBarBackgroundColor" id="navbar">
      ...
      <view class="tn-flex tn-flex-col-center tn-flex-row-center" :style="[navBarStyle2]">
        <view class="tn-text-bold tn-text-xl">话题社区</view>
      </view>
    </tn-nav-bar>
          ...
          <view class="tn-flex tn-flex-col-center tn-flex-row-left">
            <view class="tn-color-white" style="width: 70vw;">
              ...
              <view class="tn-padding-right tn-padding-top-xs tn-text-ellipsis tn-text-sm">
                <text class="tn-padding-right-sm">来自智途内部成员的浪漫，在这里发现创意</text>
              </view>
            </view>
          </view>
        </view>
        <view class="justify-content-item tn-flex-row-center">
          <view class="logo-pic tn-shadow">
            <view class="logo-image">
              <view class="tn-shadow-blur" style="background-image:url('https://cdn.nlark.com/yuque/0/2023/jpeg/280373/1683560456377-assets/web-upload/03c72b5e-219c-4aab-875f-17bda8ee0358.jpeg');width: 110rpx;height: 110rpx;background-size: cover;">
              </view>
            </view>
          </view>
        </view>
    ...
    <tn-modal v-model="show1" :custom="true">
      <view class="custom-modal-content">
        ...
        <view class="tn-text-center tn-padding-top">欢迎加入智途【开源技术】群</view>
    ...
    <view class="group-wrap tn-bg-white" id="page_tips">
      ...
      <view class="tn-padding-top-xl tn-padding-bottom-xl">
        ...
        <block v-for="(item,index) in content" :key="index">
          <view class="blogger__item home-shadow tn-margin-left tn-margin-right tn-margin-bottom">
